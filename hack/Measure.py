...
def ms(path):
    ...
    while(True):
        #ref,frame = cap.read()
        frame = cv2.resize(cap, None, fx=1, fy=1, interpolation=cv2.INTER_AREA)
        ...
        cv2.putText(orig, " {}".format(hitung_objek),(10,50),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255),2, cv2.LINE_AA)  
